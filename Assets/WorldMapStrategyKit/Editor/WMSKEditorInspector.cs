    ...
    public partial class WMSKEditorInspector : Editor {
        ...
        void ExecuteMoveTool(Vector2 mousePosition) {
            ...
            for (int i = 0; i < points.Length; i++) {
                ...
                var fmh_1821_61_638766219992930400 = mapTransform.rotation; newPoint = Handles.FreeMoveHandle(oldPoint, handleSize, pointSnap,
        ...
        void ExecuteCityMoveTool() {
            ...
            var fmh_2000_65_638766219992964017 = mapTransform.rotation; Vector3 newPoint = Handles.FreeMoveHandle(oldPoint, handleSize, pointSnap,
                                                   (handleControlID, position, rotation, size, eventType) => {
        ...
        void ExecuteMountPointMoveTool() {
            ...
            var fmh_2086_65_638766219992968909 = mapTransform.rotation; Vector3 newPoint = Handles.FreeMoveHandle(oldPoint, handleSize, pointSnap,
                                                                   (handleControlID, position, rotation, size, eventType) => {
                                                                       Handles.RectangleHandleCap(handleControlID, position, rotation, size, eventType);
                                                                   });
            if (newPoint != oldPoint) {
